/**
 * Copyright (c) 2012 Reficio (TM) - Reestablish your software! All Rights Reserved. Licensed to the Apache Software
 * Foundation (ASF) under one or more contributor license agreements. See the NOTICE file distributed with this work for
 * additional information regarding copyright ownership. The ASF licenses this file to You under the Apache License,
...
public class BundlePublisher
{
   ...
   public BundlePublisher(Boolean compressSite, String additionalArgs,
      MavenProject mavenProject, MavenSession mavenSession, BuildPluginManager buildPluginManager, String sourceDirectory, String repositoryDirectory)
   {
   ...
   public void execute() throws MojoExecutionException, IOException
   {
      executeMojo(
         ...
         configuration(
            ...
            element(name("sourceLocation"), sourceDirectory),
            element(name("metadataRepositoryLocation"), repositoryDirectory),
            element(name("artifactRepositoryLocation"), repositoryDirectory)),
   ...
   public static class Builder
   {
      ...
      {
         checkNotNull(sourceDirectory, "sourceDirectory cannot be null");
         this.sourceDirectory = sourceDirectory;
         return this;
      }
      ...
      {
         checkNotNull(repositoryDirectory, "repositoryDirectory cannot be null");
         this.repositoryDirectory = repositoryDirectory;
         return this;
      }
      ...
      public BundlePublisher build()
      {
         return new BundlePublisher(compressSite, additionalArgs, checkNotNull(mavenProject),
            checkNotNull(mavenSession), checkNotNull(buildPluginManager), checkNotNull(sourceDirectory), checkNotNull(repositoryDirectory));
      }
   }
}
