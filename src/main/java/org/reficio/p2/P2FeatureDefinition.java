...
public class P2FeatureDefinition
{
   ...
   private File featureJarContent;
   private String id;
   ...
   public File getFeatureJarContent() {
      return featureJarContent;
   }

   public void setFeatureJarContent(File featureJarContent) {
      this.featureJarContent = featureJarContent;
   }
